"""
Django settings for SentimentAnalysisPR project.
...
SECRET_KEY = '%=fn#00ct*(%9$i78z+7)&9b==13vvu7u5$nx1^2lzqb!11tn1'
...
ROOT_URLCONF = 'SentimentAnalysisPR.urls'
...
WSGI_APPLICATION = 'SentimentAnalysisPR.wsgi.application'
